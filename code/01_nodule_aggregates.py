...
OUTPUT_DIR = Path('data_tidy')
OUTPUT_TAG = 'new_geno_nodule_2024_04_03'
...
adatas_joint.obs.to_csv(OUTPUT_DIR / (OUTPUT_TAG + '.csv'))
adatas_joint.var = adatas_geno['ML_I_2'].var
adatas_joint.varm = adatas_geno['ML_I_2'].varm
adatas_joint.write(OUTPUT_DIR / (OUTPUT_TAG + '.h5ad'))
